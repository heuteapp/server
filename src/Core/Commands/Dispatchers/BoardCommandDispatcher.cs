    ...
    BoardPlacementService boardPlacementService)
{
    ...
    {
        boardPlacementService.AddCard(context.Board, context.Layout, e.Payload.Definition);
    }
    ...
    {
        boardPlacementService.DeleteCard(context.Board, context.Layout, e.Payload.Key);
    }
}